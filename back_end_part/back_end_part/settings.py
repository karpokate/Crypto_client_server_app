"""
Django settings for back_end_part project.
...
SECRET_KEY = '4^vct!g@f)z*7=n-yoz*z2q*z@jt)s&r&a)an-#=+%w_$2sp(n'
...
ROOT_URLCONF = 'back_end_part.urls'
...
WSGI_APPLICATION = 'back_end_part.wsgi.application'
